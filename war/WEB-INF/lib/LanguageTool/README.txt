...
Usage:
 ...
 1. Double-click LanguageTool-2.0.oxt. The extension should
...
Using LanguageTool from .NET:
 ...
 mono /path/to/ikvm/bin/ikvmc.exe -target:library -r:/path/to/ikvm/bin/IKVM.OpenJDK.Core.dll libs/morfologik-fsa-1.5.3.jar:morfologik-stemming-1.5.3.jar
 mono /path/to/ikvm/bin/ikvmc.exe -target:library -r:/path/to/ikvm/bin/IKVM.OpenJDK.Core.dll libs/jWordSplitter.jar
 mono /path/to/ikvm/bin/ikvmc.exe -r:/path/to/ikvm/bin/IKVM.OpenJDK.Core.dll -r:morfologik-fsa-1.5.3.jar:morfologik-stemming-1.5.3.jar -r:jWordSplitter.dll LanguageTool.jar
